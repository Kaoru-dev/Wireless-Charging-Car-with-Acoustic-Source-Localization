...
//extern short sound_data_forward[2348];
//extern short sound_data_back[2348];
//extern short sound_data_left[2348];
//extern short sound_data_right[2348];
//extern uint8 sound_flag;
/**
 * 	STM模块枚举
 */
typedef enum
