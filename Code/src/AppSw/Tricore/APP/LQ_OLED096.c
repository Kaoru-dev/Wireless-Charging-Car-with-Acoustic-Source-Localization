 ...
 *  float   speedGiaP           = 50;
    float   speedGiaD           = 0;
    float   speedGiaI           = 30;
    float   currentKP1          = 3;        //电流环KP
    float   currentKD1          = 0;           //电流环KD
    float   currentKI1          = 0.1;         //电流环KI
 */
void MY_oled(){//KEY0上用于mode ，key1用于加减
...
switch(count){
  // case 0:if(KEY_Read(KEY1)==0)Charge_Flag=!Charge_Flag;delayms(100);break;
//   case 0:if(KEY_Read(KEY1)==0) currentDesired1=currentDesired1+10;delayms(100);break;
//    case 1:if(KEY_Read(KEY1)==0)currentDesired1=currentDesired1-10;delayms(100);break;
//    case 0:if(KEY_Read(KEY1)==0) Charge_Flag_start=!Charge_Flag_start;delayms(500);break;
//    case 1:if(KEY_Read(KEY1)==0)Charge_Flag_start=!Charge_Flag_start;delayms(500);break;
    case 2:if(KEY_Read(KEY1)==0)speedGiaP++;delayms(100);break;
    case 3:if(KEY_Read(KEY1)==0)speedGiaP--;delayms(100);break;
    case 4:if(KEY_Read(KEY1)==0)speedGiaI=speedGiaI+0.1;delayms(100);break;
    case 5:if(KEY_Read(KEY1)==0)speedGiaI=speedGiaI-0.1;delayms(100);break;
    case 6:if(KEY_Read(KEY1)==0)speedGiaD++;delayms(100);break;
    case 7:if(KEY_Read(KEY1)==0)speedGiaD--;delayms(100);break;
    case 8:if(KEY_Read(KEY1)==0)currentKP1=currentKP1+0.1;  delayms(100);break;
    case 9:if(KEY_Read(KEY1)==0)currentKP1=currentKP1-0.1;  delayms(100);break;
    case 10:if(KEY_Read(KEY1)==0)currentKI1=currentKI1+0.01; delayms(100);break;
    case 11:if(KEY_Read(KEY1)==0)currentKI1=currentKI1-0.01; delayms(100);break;
    case 12:if(KEY_Read(KEY1)==0)currentKD1=currentKD1+0.1; delayms(100);break;
    case 13:if(KEY_Read(KEY1)==0)currentKD1=currentKD1-0.1; delayms(100);break;

}
    sprintf(txt, "mode %d ", Charge_Flag_start);  // *3.3/4095
    OLED_P8x16Str(0,0,txt);
//   sprintf(txt, "char %d ", Charge_Flag);  // *3.3/4095
//    OLED_P8x16Str(0,0,txt);
    sprintf(txt, "sSet %d ", speedSet_left);  // *3.3/4095
    OLED_P8x16Str(64,0,txt);
    sprintf(txt, "sP %3.1f ", speedGiaP);  // *3.3/4095
    OLED_P8x16Str(0,2,txt);
    sprintf(txt, "sI %3.1f ", speedGiaI);  // *3.3/4095
    OLED_P8x16Str(64,2,txt);
    sprintf(txt, "sD %3.1f ", speedGiaD);  // *3.3/4095
    OLED_P8x16Str(0,4,txt);
    sprintf(txt, "cp %3.1f ", currentKP1);  // *3.3/4095
    OLED_P8x16Str(64,4,txt);
    sprintf(txt, "cI %3.2f ", currentKI1);  // *3.3/4095
    OLED_P8x16Str(0,6,txt);
    sprintf(txt, "cD %3.1f ", currentKD1);  // *3.3/4095
    OLED_P8x16Str(64,6,txt);
}
