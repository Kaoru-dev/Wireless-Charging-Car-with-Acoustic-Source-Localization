...
{
	  // 初始化,输入口，高电平
	  PIN_InitConfig(KEY0p, PIN_MODE_INPUT_PULLUP, 0);
	  PIN_InitConfig(KEY1p, PIN_MODE_INPUT_PULLUP, 0);
	  PIN_InitConfig(KEY2p, PIN_MODE_INPUT_PULLUP, 0);
	  PIN_InitConfig(DSW0p, PIN_MODE_INPUT_PULLUP, 0);
	  PIN_InitConfig(DSW1p, PIN_MODE_INPUT_PULLUP, 0);
	  PIN_InitConfig(P13_1, IfxPort_Mode_inputPullDown, 1);
	  PIN_InitConfig(P13_2, IfxPort_Mode_inputPullDown, 1);
}

void select_speedmode(){
    mode1= PIN_Read(P13_1);
    mode2= PIN_Read(P13_2);
}
/*************************************************************************
