...
IFX_EXTERN cfloat32 *Ifx_FftF32_radix2(cfloat32 *R, const cfloat32 *X, unsigned short nX);
IFX_EXTERN void FFT(cfloat32 *R, const short *X, unsigned short nX);
IFX_EXTERN void IFFT(cfloat32 *X,unsigned short nX);
//IFX_EXTERN void FFT2(short *X,cfloat32 * R,unsigned short nX);

/** \brief Radix-2 Inverse Fast-Fourier Transform */
IFX_EXTERN cfloat32 *Ifx_FftF32_radix2I(cfloat32 *R, const cfloat32 *X, unsigned short nX);
//IFX_EXTERN void IFFT2(cfloat32 *X,unsigned short nX);
